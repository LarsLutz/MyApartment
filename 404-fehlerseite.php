		...
		<!-- Wrapper -->
			<div id="wrapper">
						...
						<div class="inner">
							...
							<!-- Logo -->
								<a href="index.php" class="logo">
                                                                    <span class="symbol"><img src="images/logo.svg" alt="" /></span><span class="title">Error 404</span>
								</a>
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
                                                    <h1>Ups! Es ist eine Fehler aufgetreten</h1>
                                                    <h2>Das sollte nicht passieren. Wir arbeiten bereits an einer Lösung</h2>
                                                    <br>
                                                    <h3>Kontaktieren sie bitte unseren Support:  <a href="mailto:admin@bclaufen.ch"><span class="label">Kontakt</span></a></h3>
